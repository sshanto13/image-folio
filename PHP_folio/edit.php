	...
	<div class="container">
        <div class="row">
			...
			<?php
				...
				$row = $model->edit($id);
			?>
                <h2 class="py-5 item-names"><?php echo $row['image_url']; ?></h2>
...
<section class="save-area bg-white">
	<div class="container">	
		<div class="row">
			...
			<div class="col-md-6 mb-3 mt-3">
				    ...
				    <li class="menu-item revert-li"> <a  class="btn revert-edit-btn mr-2" href="revert.php?id=<?php echo $row['id']; ?>" >Revert</a></li>
    ...
    <script>
    	var imgURL = 'http://localhost/PHP_folio/images/'+'<?php if($row['update_image_url']){ echo $row['update_image_url'];}else{ echo $row['image_url'];} ?>';
